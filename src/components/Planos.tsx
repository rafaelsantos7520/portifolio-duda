      ...
      <div className="container mx-auto px-6">
          ...
          {packages.map((pkg, i) => (
            <div
              ...
              className={`relative bg-white rounded-3xl p-8 border transition-all duration-300 hover:shadow-xl flex flex-col ${
                pkg.highlight ? "border-rose-200 shadow-lg" : "border-stone-100 hover:border-stone-200"
              }`}
            >
              {pkg.highlight && (
        ...
        <div className="hidden md:grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {packages.map((pkg, index) => (
            <div
              key={index}
              className={`relative bg-white rounded-3xl p-8 border transition-all duration-300 hover:shadow-xl flex flex-col reveal hover-float ${
